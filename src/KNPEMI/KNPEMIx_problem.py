...
class ProblemKNPEMI(MixedDimensionalProblem):
    ...
    Na_i_init  = 121        # intracellular Na concentration (mM) (Constant)
    Na_e_init  = 100       # extracellular Na concentration (mM) (Constant)
    K_i_init   = 125       # intracellular K  concentration (mM) (Constant)
    K_e_init   = 4         # extracellular K  concentration (mM) (Constant)
    Cl_i_init  = 137       # intracellular Cl concentration (mM) (Constant)
    Cl_e_init  = 104       # extracellular Cl concentration (mM) (Constant)
